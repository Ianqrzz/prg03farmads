...
public class ClienteListar extends javax.swing.JFrame {
    ...
    listaClientes = controller.listAll();
    ...
    private void initComponents() {
        ...
        sclClientesLista.setViewportView(tblClientes);
    ...
    private void btnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarActionPerformed
        AdicionarClientes telaAdd = new AdicionarClientes(this, true, this.controller);
    ...
    Long id = clienteSelecionado.getId();
    ...
    ClienteEditar telaEditar =
        new ClienteEditar(clienteSelecionado, controller);
    ...
    for (Cliente cliente : listaClientes) {
        if (cliente.getNome().toLowerCase().contains(nomePesquisado)) {
            model.addRow(new Object[]{
                cliente.getNome(),
                cliente.getCpf(),
                cliente.getEmail(),
